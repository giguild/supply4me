<template>
    <AppLayout :user="$page.props.auth.user">
        <PageHeader title="Edit User" subtitle="Update user information and role">
            <template #actions>
            ...
            <form @submit.prevent="submit">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input v-model="form.password" type="password" class="form-input" :class="{ 'border-red-500': form.errors.password }" placeholder="Leave blank to keep current password" />
...
const form = useForm({
    ...
    branches: props.user.branches?.map(b => b.id) || [],
