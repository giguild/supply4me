        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="text-center">
            <div class="inline-flex items-center gap-2 bg-[#9F5124]/10 border border-[#9F5124]/20 rounded-full px-4 py-2 mb-5">
              ...
              <span class="text-sm font-medium text-[#9F5124]">CREATE ACCOUNT</span>
            </div>
            <h1 class="text-3xl sm:text-4xl font-extrabold text-white mb-3">
              Join <span class="text-[#9F5124]">Supply 4 Me</span>
            </h1>
            <p class="text-white/60">Create an account to start ordering quality FMCG products</p>
          </div>
        </div>
      </section>
          ...
          <div class="bg-white rounded-3xl border border-[#2D2C2C]/5 p-8 shadow-sm">
            <form @submit.prevent="submit">
              <div class="space-y-5">
                <!-- Full Name -->
                <div>
                  <label class="block text-sm font-semibold text-[#2D2C2C] mb-2">Full Name</label>
                  <div class="relative">
                    <input
                      v-model="form.name"
                      type="text"
                ...
                <!-- Phone -->
                <div>
                  <label class="block text-sm font-semibold text-[#2D2C2C] mb-2">Phone Number</label>
                  <div class="relative">
                    <input
                      v-model="form.phone"
                      type="text"
                ...
                <!-- Confirm Password -->
                <div>
                  <label class="block text-sm font-semibold text-[#2D2C2C] mb-2">Confirm Password</label>
                  <div class="relative">
                    <input
