<template>
    <AppLayout :user="$page.props.auth.user">
        <div class="flex items-center gap-3 mb-6">
            <Link :href="route('orders.index')" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-400">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <div class="card p-5">
                ...
                <p class="text-sm font-semibold text-gray-900 dark:text-gray-100">{{ order.customer?.name }}</p>
            </div>
            <div class="card p-5">
        ...
        <div class="card overflow-hidden mb-6">
            <div class="px-6 py-4 border-b border-gray-100">
                <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Order Items</h3>
            </div>
        ...
        <div v-if="order.statusHistory?.length" class="card p-6">
            <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-5">Status History</h3>
            <div class="relative">
