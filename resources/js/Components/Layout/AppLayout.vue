...
const icons = {
    ...
    roles: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>',
    salesRep: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/><path d="M19 8l2 2-2 2"/></svg>',
    branches: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>',
    ...
    salesReport: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/></svg>',
    inventoryReport: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>',
    financialReport: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8V7m0 10v1m-8-5H3m18 0h-2"/></svg>',
    expenses: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2z"/></svg>',
    expenseCategories: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A2 2 0 013 12V7a4 4 0 014-4z"/></svg>',
...
const adminMoreNavGroups = computed(() => [
    {
        label: 'Operations',
        items: [
            { label: 'GRN', route: 'grn.index', icon: icons.stock, permission: 'grn.view' },
            { label: 'Pick Lists', route: 'pick-lists.index', icon: icons.stock, permission: 'picklist.view' },
            { label: 'Packing Lists', route: 'packing-lists.index', icon: icons.stock, permission: 'packinglist.view' },
            { label: 'Expenses', route: 'expenses.index', icon: icons.expenses, permission: 'expense.view' },
            { label: 'Expense Categories', route: 'expense-categories.index', icon: icons.expenseCategories, permission: 'expense-category.view' },
        ],
    },
    {
        label: 'Shipping',
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'Roles', route: 'roles.index', icon: icons.roles, permission: 'role.view' },
            { label: 'Sales Reps', route: 'sales-reps.index', icon: icons.salesRep, permission: 'customer.view' },
            { label: 'Branches', route: 'branches.index', icon: icons.branches, permission: 'branch.view' },
        ],
    },
    {
        label: 'Reports',
        items: [
            { label: 'Sales Report', route: 'reports.sales', icon: icons.salesReport, permission: 'report.view-sales' },
            { label: 'Inventory Report', route: 'reports.inventory', icon: icons.inventoryReport, permission: 'report.view-inventory' },
            { label: 'Financial Report', route: 'reports.financial', icon: icons.financialReport, permission: 'report.view-financial' },
        ],
    },
].map(group => ({
    ...group,
