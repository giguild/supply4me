  ...
  <div class="min-h-screen bg-[var(--color-bg)] flex flex-col overflow-x-hidden">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          ...
          <div class="flex items-center gap-3">
            ...
            <!-- Wishlist -->
            <a v-if="customer" href="/wishlist" class="p-2 text-[var(--color-text)] hover:text-accent transition-colors">
    ...
    <nav v-if="customer" class="sm:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-[var(--color-border)] dark:bg-gray-900 dark:border-gray-700 z-50 safe-bottom">
      <div class="grid grid-cols-5 gap-0">
        ...
        <a href="/wishlist" class="flex flex-col items-center py-2 text-[var(--color-text-secondary)] hover:text-accent transition-colors" :class="{ 'text-accent': currentPage === 'wishlist' }">
